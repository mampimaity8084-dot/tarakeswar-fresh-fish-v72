const C='tff-v7-smart-experience-20260824-1';const A=['/','/index.html','/logo-transparent.png','/app-icon-192.png','/app-icon-512.png','/manifest.webmanifest','/supabase-config.js','/tff-v6-runtime.js','/tff-v7-smart-experience.js','/app-version.json'];self.addEventListener('install',e=>e.waitUntil(
